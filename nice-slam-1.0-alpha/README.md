...
<p align="center">
(GT/predicted trajectory is indicated as black/red)
</p>
<br>
...
```bash
python src/tools/cull_mesh.py --input_mesh Dataset/Replica/room0.ply --traj Dataset/Replica/room0/traj.txt --output_mesh cull_replica_mesh/room0.ply
```
